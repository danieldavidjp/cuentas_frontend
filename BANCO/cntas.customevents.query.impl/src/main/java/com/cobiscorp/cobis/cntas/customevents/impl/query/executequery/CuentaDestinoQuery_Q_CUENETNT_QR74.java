/*
 * Archivo: CuentaDestinoQuery_Q_CUENETNT_QR74.java
 *
...
@Properties(value={
		@Property(name = "query.id", value = "Q_CUENETNT_QR74"),
		@Property(name = "query.version", value = "1.0.0")})

public class CuentaDestinoQuery_Q_CUENETNT_QR74 implements IExecuteQuery {
	/**
	 * Instancia de Logger
	 */
	private static final ILogger logger = LogFactory.getLogger(CuentaDestinoQuery_Q_CUENETNT_QR74.class);
